        ...
        if(attackTimer <= 0f)
        {
            ...
            switch (weaponLevel)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    base.GenerateBullet(new Vector3(transform.parent.position.x - 0.6f, transform.parent.position.y + 0.3f), new Vector3(0.8f, 0.8f, 1f), 0f);
                    base.GenerateBullet(new Vector3(transform.parent.position.x - 0.3f, transform.parent.position.y + 0.6f), new Vector3(0.8f, 0.8f, 1f), 0f);
                    base.GenerateBullet(new Vector3(transform.parent.position.x + 0.6f, transform.parent.position.y + 0.3f), new Vector3(0.8f, 0.8f, 1f), 0f);
                    base.GenerateBullet(new Vector3(transform.parent.position.x + 0.3f, transform.parent.position.y + 0.6f), new Vector3(0.8f, 0.8f, 1f), 0f);
                    base.GenerateBullet(new Vector3(transform.parent.position.x, transform.parent.position.y + 0.7f), new Vector3(0.8f, 0.8f, 1f), 0f);
                    break;
                case 5:
                    base.GenerateBullet(new Vector3(transform.parent.position.x - 0.6f, transform.parent.position.y + 0.3f), new Vector3(1.1f, 1.1f, 1f), 0f);
                    base.GenerateBullet(new Vector3(transform.parent.position.x - 0.3f, transform.parent.position.y + 0.6f), new Vector3(0.8f, 0.8f, 1f), 0f);
                    base.GenerateBullet(new Vector3(transform.parent.position.x + 0.6f, transform.parent.position.y + 0.3f), new Vector3(1.1f, 1.1f, 1f), 0f);
                    base.GenerateBullet(new Vector3(transform.parent.position.x + 0.3f, transform.parent.position.y + 0.6f), new Vector3(0.8f, 0.8f, 1f), 0f);
                    base.GenerateBullet(new Vector3(transform.parent.position.x, transform.parent.position.y + 0.7f), new Vector3(1.1f, 1.1f, 1f), 0f);
                    break;
                default:
                    print("default case");
                    break;
